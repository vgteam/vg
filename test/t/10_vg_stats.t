...
is $(vg msga -f msgas/cycle.fa -b s1 -w 64 -t 1 | vg mod -U 10 - | vg stats -O - | wc -l) 41 "a path overlap description of a cyclic graph built by msga has the expected length"
