...
is $(vg msga -f msgas/cycle.fa -b s1 -w 20 -k 8 -t 1 | vg mod -U 10 - | vg stats -O - | wc -l) 77 "a path overlap description of a cyclic graph built by msga has the expected length"
