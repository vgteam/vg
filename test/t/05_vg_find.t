...
node_matches=$(vg find -k TAAGGTTTGAA -c 0 x.vg | vg view -g - | grep "^S" | cut -f 2 | grep '1$\|3$\|8$\|9$\|13$\|14$' | wc -l)
is $node_matches 6 "correct number of nodes for kmer find"

edge_matches=$(vg find -k TAAGGTTTGAA -c 0 x.vg | vg view -g - | grep "^L" | cut -f 2 | grep '1$\|3$\|8$\|9$\|13$\|14$' | wc -l)
