...
is $(vg msga -f GRCh38_alts/FASTA/HLA/V-352962.fa -t 1 | vg mod -U 10 - | vg view - | grep ^S | cut -f 3 | sort | md5sum | cut -f 1 -d\ ) 16e56f0090b310d2b1479d49cf790324 "MSGA produces the expected graph for GRCh38 HLA-V"
...
is $(vg msga -f msgas/s.fa | vg mod -U 10 - | vg view - | md5sum | cut -f 1 -d\ ) 65091adcc9ee98c64abe68af6be19863 "msga alignment can detect and include large deletions in the graph"
...
is $(vg msga -f msgas/cycle.fa -b s1 -B 20 -t 1 | vg mod -U 10 - | vg view - | wc -l) 72 "a cyclic path can be normalized"
