...
is $(vg msga -f msgas/s.fa -k 16 -b s1 -B 20 | vg view - | md5sum | cut -f 1 -d\ ) cece7211dc233fa2287b717674ddbf22 "banded alignment can detect and include large deletions in the graph"

is $(vg msga -f msgas/s.fa -k 16 -b s2 -B 20 | vg view - | md5sum | cut -f 1 -d\ ) cece7211dc233fa2287b717674ddbf22 "assembly around indels works regardless of the base sequence that is used"
