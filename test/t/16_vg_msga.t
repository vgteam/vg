...
is $(vg msga -f msgas/inv.fa -w 8 | vg mod -U 10 - | vg view -j - | jq -c '.path[] | select(.name == "inv") | .mapping[] | select(.position.is_reverse)'  | wc -l) 2 "a reference sequence set representing an inversion in it maybe msga'd and detected"
