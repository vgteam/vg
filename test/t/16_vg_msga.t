...
vg msga -f msgas/cycle.fa -b s2 -w 16 -t 1 | vg validate -
is $? 0 "a difficult cyclic path can be included to produce a valid graph"

is $(vg msga -f msgas/cycle.fa -b s2 -w 16 -t 1 | vg mod -D - | vg mod -U 10 - | vg view - | grep ^S | wc -l) 2 "a cyclic path can be normalized"
