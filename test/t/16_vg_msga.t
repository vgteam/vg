...
is $(vg msga -f msgas/inv.fa -w 8 | vg mod -U 10 - | vg mod -X 10 - | vg stats -O - | tr '\t' ' ' | grep 'fwd____inv 10 17\|fwd____inv 17 10' | wc -l) 2 "a reference sequence set representing an inversion in it maybe msga'd and detected"
