...
is $(vg locify -g tiny.gam.index -b 4 -x tiny.vg.xg -l tiny.loci -f -n -s loci.sorted | vg view -a - | jq . | grep -A 3 '15+3_20+0' | grep name | grep -v '15+3_20+0' | sort | uniq -c | wc -l) 4 "limitation to 4-best works"
