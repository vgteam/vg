...
is $(0) 0 "vg deconstruct produces the expected number of superbubbles in a simple graph."

## Make sure deconstruct successfully finds the right nodes in a superbubble of a simple graph.
is $(0) 0 "vg deconstruct produces the expected superbubble format and the right bubbles on a small graph."
