...
$(INC_DIR)/mio/mmap.hpp:$(MMMULTIMAP_DIR)/deps/mio/include/mio/mmap.hpp
	+rm -rf $(CWD)/$(INC_DIR)/mio && cp -r $(MMMULTIMAP_DIR)/deps/mio/include/mio $(CWD)/$(INC_DIR)/

$(INC_DIR)/atomic_queue.h:$(MMMULTIMAP_DIR)/deps/atomic_queue/include/atomic_queue/atomic_queue.h
	+cp $(MMMULTIMAP_DIR)/deps/atomic_queue/include/atomic_queue/* $(CWD)/$(INC_DIR)/
