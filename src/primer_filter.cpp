...
const vector<Primer_pair>& Primer_finder::get_primer_pairs() const {
    return primer_pairs;
}

const vector<Primer_pair>& Primer_finder::get_selected_primer_pairs() const {
...
void Primer_finder::make_primer(Primer& primer, const size_t& starting_node_id,
...
size_t Primer_finder::longest_match_len(Primer& primer, const string& left_seq,
...
const string Primer_finder::rstrip(const string& s) const {
...
const bool Primer_finder::no_variation(const Primer_pair& primer_pair) const {
