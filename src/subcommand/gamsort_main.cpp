...
static Subcommand vg_gamsort("gamsort", "sort a GAM/GAF file or index a sorted GAM file", WIDGET,
                             vector<manpage_item>{{MANIPULATE_ALN, "sort a GAM/GAF file or index a sorted GAM file", ""}},
                             help_gamsort, main_gamsort);
