...
int main_giraffe(int argc, char** argv) {
    ...
    presets["hifi"]
        ...
        .add_entry<size_t>("fragment-max-min-score", 50000)
        .add_entry<size_t>("fragment-min-score", 0)
        .add_entry<size_t>("fragment-set-score-threshold", 5000)
        ...
        .add_entry<size_t>("item-bonus", 0)
        .add_entry<size_t>("item-scale", 1)
        .add_entry<size_t>("gap-scale", 1)
        .add_entry<size_t>("chain-score-threshold", 200)
        .add_entry<size_t>("min-chains", 2)
        .add_entry<double>("min-chain-score-per-base", 0.25)
        .add_entry<size_t>("max-min-chain-score", 800)
