...
int main_giraffe(int argc, char** argv) {
    ...
    presets["hifi"]
        ...
        .add_entry<size_t>("max-chain-connection", 443)
        .add_entry<size_t>("max-tail-length", 130)
        .add_entry<size_t>("max-tail-gap", 300)
        .add_entry<int>("wfa-distance", 15)
        .add_entry<double>("wfa-distance-per-base", 0.141638)
        .add_entry<int>("wfa-max-distance", 254)
    ...
    presets["sr"]
        ...
        .add_entry<double>("gap-scale", 5.8)
        .add_entry<size_t>("fragment-max-lookback-bases", 350)
        .add_entry<double>("fragment-max-lookback-bases-per-base", 0)
        .add_entry<size_t>("fragment-max-indel-bases", 1500)
        .add_entry<double>("fragment-max-indel-bases-per-base", 0)
        // And take those to chains
        .add_entry<bool>("skip-chaining", true)
        .add_entry<double>("fragment-score-fraction", 0.4)
        .add_entry<double>("fragment-min-score", 45)
