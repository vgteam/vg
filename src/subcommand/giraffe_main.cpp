...
int main_giraffe(int argc, char** argv) {
    ...
    presets["r10"]
        ...
        .add_entry<size_t>("fragment-max-lookback-bases", 500)
        .add_entry<double>("fragment-max-lookback-bases-per-base", 0.008)
        .add_entry<size_t>("fragment-max-indel-bases", 600)
        .add_entry<double>("fragment-max-indel-bases-per-base", 0.002)
        .add_entry<double>("fragment-gap-scale", 3.0)
        .add_entry<double>("fragment-score-fraction", 0.15)
        .add_entry<double>("fragment-max-min-score", 50000)
        .add_entry<double>("fragment-min-score", 0)
        .add_entry<double>("fragment-set-score-threshold", 3000)
