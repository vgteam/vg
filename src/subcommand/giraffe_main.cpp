...
int main_giraffe(int argc, char** argv) {
    ...
    presets["hifi"]
        ...
        .add_entry<double>("fragment-max-lookback-bases-per-base", 0.004)
        .add_entry<size_t>("fragment-max-indel-bases", 4000)
        .add_entry<double>("fragment-max-indel-bases-per-base", 0.007)
        .add_entry<double>("fragment-gap-scale", 4.8)
        .add_entry<double>("fragment-score-fraction", 0.3)
        .add_entry<double>("fragment-max-min-score", 70000.0)
        .add_entry<double>("fragment-min-score", 0)
        .add_entry<double>("fragment-set-score-threshold", 4000.0)
        .add_entry<int>("min-chaining-problems", 5)
        .add_entry<int>("max-chaining-problems", std::numeric_limits<int>::max())
        .add_entry<size_t>("max-lookback-bases", 12000)
        .add_entry<double>("max-lookback-bases-per-base", 0.25)
        .add_entry<size_t>("max-indel-bases", 15000)
        .add_entry<double>("max-indel-bases-per-base", 0.2)
        .add_entry<int>("item-bonus", 0)
        .add_entry<int>("item-scale", 2.0)
        .add_entry<double>("gap-scale", 0.75)
        .add_entry<double>("chain-score-threshold", 200.0)
        .add_entry<int>("min-chains", 3.0)
        .add_entry<double>("min-chain-score-per-base", 0.25)
        .add_entry<int>("max-min-chain-score", 650.0)
