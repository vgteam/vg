...
// Register subcommand
static Subcommand vg_align("align", "local alignment", WIDGET,
                           vector<manpage_item>{{RARE_NEEDS, "run highly configurable alignment of a single sequence", ""}},
                           help_align, main_align);
