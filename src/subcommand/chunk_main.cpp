...
// Register subcommand
static Subcommand vg_chunk("chunk", "split graph or alignment into chunks", WIDGET,
                           vector<manpage_item>{{EXTRACT_GRAPH, "split a graph and/or alignment into smaller chunks", ""}},
                           help_chunk, main_chunk);
