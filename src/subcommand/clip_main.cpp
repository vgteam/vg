...
// Register subcommand
static Subcommand vg_clip("clip", "remove BED regions (other other nodes from their snarls) from a graph", WIDGET,
                          vector<manpage_item>{{MANIPULATE_GRAPH, "remove variation from a graph", ""}},
                          help_clip, main_clip);
