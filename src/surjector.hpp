...
using namespace std;
    ...
    private:
        ...
        extract_overlapping_paths(const Alignment& source, const string& path_name,
                                  unordered_map<int64_t, vector<size_t>>* paths_of_node_memo = nullptr);
        
        pair<size_t, size_t>
        compute_path_interval(const Alignment& source, size_t path_rank, const XGPath& xpath,
        ...
        VG extract_linearized_path_graph(size_t begin, size_t end, const XGPath& xpath,
