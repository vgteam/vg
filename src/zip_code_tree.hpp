...
public:
    ...
    std::pair<size_t, size_t> dag_and_non_dag_snarl_count(const vector<Seed>& all_seeds, 
...
class ZipCodeForest {
    ...
    /// It represents one interval along zipcode_sort_order, which corresponds to
    /// a snarl tree node at the given depth
