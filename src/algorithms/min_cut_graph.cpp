    ...
    namespace algorithms {
        ...
        structures::UnionFind kargers_min_cut(Graph graph, const int n_iterations, const int seed, int V) {
            ...
            while(V > 2){
                ...
                size_t random_weight_idx = nodes_distribution(random_engine);
                ...
                int other_node;
                size_t random_edge_weight_idx = edges_distribution(random_engine);
                int count = 0;
                ...
                if(cg.get_nodes().size() == 2){
                    ...
                    vector<size_t> d1, d2;
                    for(int i = 0; i<cg.get_nodes().size(); i++){
                        vector<int> d_set;
        ...
        pair<vector<vector<size_t>>, size_t> compute_min_cut(Graph graph, const int n_iterations, const int seed, int V){
            ...
            pair<vector<vector<size_t>>, size_t> min_cut2 = kargers_min_cut(graph, n_iterations, seed, V);
