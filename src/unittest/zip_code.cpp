...
using namespace std;
    ...
    TEST_CASE("One node zipcode", "[zipcode]") {
        ...
        SECTION("decoder") {
            ...
            REQUIRE(decoder.decoder.front().is_chain == 1);
            REQUIRE(decoder.decoder.front().offset == 0);
        }
    ...
    TEST_CASE("Simple chain zipcode", "[zipcode]") {
        ...
        SECTION ("zip code for node on top-level chain") {
            ...
            pair<size_t, size_t> value_and_index = zipcode.zipcode.get_value_and_next_index(0);
            REQUIRE(value_and_index.first == 1);
            REQUIRE(decoder.decoder[0] == ZipCodeDecoder::decoder_t(true, (size_t)0));
            ...
            REQUIRE(decoder.decoder[1] == ZipCodeDecoder::decoder_t(true, value_and_index.second));
            value_and_index = zipcode.zipcode.get_value_and_next_index(value_and_index.second);
        ...
        SECTION ("zip code for node in simple snarl") {
            ...
            REQUIRE(decoder.decoder[1] == ZipCodeDecoder::decoder_t(false, value_and_index.second));
            value_and_index = zipcode.zipcode.get_value_and_next_index(value_and_index.second);
            REQUIRE(value_and_index.first == 1);
            ...
            REQUIRE(decoder.decoder[2] == ZipCodeDecoder::decoder_t(true, value_and_index.second));
            value_and_index = zipcode.zipcode.get_value_and_next_index(value_and_index.second);
    ...
    TEST_CASE("Nested snarl zipcode", "[zipcode]") {
        ...
        SECTION ("zip code for node on in nested chain") {
            ...
            //Next is the node code
            REQUIRE(decoder.decoder[3] == ZipCodeDecoder::decoder_t(true, value_and_index.second));
        ...
        SECTION ("zip code for more deeply nested node") {
            ...
            REQUIRE(decoder.decoder[3] == ZipCodeDecoder::decoder_t(false, value_and_index.second));
            ...
            REQUIRE(decoder.decoder[4] == ZipCodeDecoder::decoder_t(true, value_and_index.second));
            //Rank in parent
            value_and_index = zipcode.zipcode.get_value_and_next_index(value_and_index.second);
            ...
            REQUIRE(decoder.decoder[5] == ZipCodeDecoder::decoder_t(false, value_and_index.second));
            value_and_index = zipcode.zipcode.get_value_and_next_index(value_and_index.second);
            REQUIRE(value_and_index.first == 1);
            ...
            REQUIRE(decoder.decoder[6] == ZipCodeDecoder::decoder_t(true, value_and_index.second));
            //rank in snarl
            value_and_index = zipcode.zipcode.get_value_and_next_index(value_and_index.second);
    ...
    TEST_CASE("Top-level snarl zipcode", "[zipcode]") {
        ...
        SECTION ("zip code for node in top-level snarl") { 
            ...
            REQUIRE(decoder.decoder[0] == ZipCodeDecoder::decoder_t(false, (size_t)0));
