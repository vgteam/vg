...
TEST_CASE("for_each_kmer() finds the correct kmers", "[gbwt_helper][gbwt]") {
    ...
    typedef std::pair<std::vector<std::pair<pos_t, pos_t>>, std::string> kmer_type;
    std::set<kmer_type> correct_kmers {
        // alt_path forward
        { { { make_pos_t(1, false, 0), make_pos_t(1, false, 1) },
            { make_pos_t(2, false, 0), make_pos_t(2, false, 1) },
            { make_pos_t(4, false, 0), make_pos_t(4, false, 1) } }, "GAG" },
        { { { make_pos_t(2, false, 0), make_pos_t(2, false, 1) },
            { make_pos_t(4, false, 0), make_pos_t(4, false, 2) } }, "AGG" },
        { { { make_pos_t(4, false, 0), make_pos_t(4, false, 3) } }, "GGG" },
        { { { make_pos_t(4, false, 1), make_pos_t(4, false, 3) },
            { make_pos_t(5, false, 0), make_pos_t(5, false, 1) } }, "GGT" },
        { { { make_pos_t(4, false, 2), make_pos_t(4, false, 3) },
            { make_pos_t(5, false, 0), make_pos_t(5, false, 1) },
            { make_pos_t(6, false, 0), make_pos_t(6, false, 1) } }, "GTA" },
        { { { make_pos_t(5, false, 0), make_pos_t(5, false, 1) },
            { make_pos_t(6, false, 0), make_pos_t(6, false, 1) },
            { make_pos_t(8, false, 0), make_pos_t(8, false, 1) } }, "TAA" },
        { { { make_pos_t(6, false, 0), make_pos_t(6, false, 1) },
            { make_pos_t(8, false, 0), make_pos_t(8, false, 1) },
            { make_pos_t(9, false, 0), make_pos_t(9, false, 1) } }, "AAA" },

        // alt_path reverse
        { { { make_pos_t(9, true, 0), make_pos_t(9, true, 1) },
            { make_pos_t(8, true, 0), make_pos_t(8, true, 1) },
            { make_pos_t(6, true, 0), make_pos_t(6, true, 1) } }, "TTT" },
        { { { make_pos_t(8, true, 0), make_pos_t(8, true, 1) },
            { make_pos_t(6, true, 0), make_pos_t(6, true, 1) },
            { make_pos_t(5, true, 0), make_pos_t(5, true, 1) } }, "TTA" },
        { { { make_pos_t(6, true, 0), make_pos_t(6, true, 1) },
            { make_pos_t(5, true, 0), make_pos_t(5, true, 1) },
            { make_pos_t(4, true, 0), make_pos_t(4, true, 1) } }, "TAC" },
        { { { make_pos_t(5, true, 0), make_pos_t(5, true, 1) },
            { make_pos_t(4, true, 0), make_pos_t(4, true, 2) } }, "ACC" },
        { { { make_pos_t(4, true, 0), make_pos_t(4, true, 3) } }, "CCC" },
        { { { make_pos_t(4, true, 1), make_pos_t(4, true, 3) },
            { make_pos_t(2, true, 0), make_pos_t(2, true, 1) } }, "CCT" },
        { { { make_pos_t(4, true, 2), make_pos_t(4, true, 3) },
            { make_pos_t(2, true, 0), make_pos_t(2, true, 1) },
            { make_pos_t(1, true, 0), make_pos_t(1, true, 1) } }, "CTC" },

        // short_path forward
        { { { make_pos_t(1, false, 0), make_pos_t(1, false, 1) },
            { make_pos_t(4, false, 0), make_pos_t(4, false, 2) } }, "GGG" },
        { { { make_pos_t(4, false, 0), make_pos_t(4, false, 3) } }, "GGG" },
        { { { make_pos_t(4, false, 1), make_pos_t(4, false, 3) },
            { make_pos_t(5, false, 0), make_pos_t(5, false, 1) } }, "GGT" },
        { { { make_pos_t(4, false, 2), make_pos_t(4, false, 3) },
        ...
        { { { make_pos_t(5, false, 0), make_pos_t(5, false, 1) },
            { make_pos_t(6, false, 0), make_pos_t(6, false, 1) },
            { make_pos_t(7, false, 0), make_pos_t(7, false, 1) } }, "TAC" },
        { { { make_pos_t(6, false, 0), make_pos_t(6, false, 1) },
            { make_pos_t(7, false, 0), make_pos_t(7, false, 1) },
            { make_pos_t(9, false, 0), make_pos_t(9, false, 1) } }, "ACA" },

        // short_path reverse
        { { { make_pos_t(9, true, 0), make_pos_t(9, true, 1) },
            { make_pos_t(7, true, 0), make_pos_t(7, true, 1) },
            { make_pos_t(6, true, 0), make_pos_t(6, true, 1) } }, "TGT" },
        { { { make_pos_t(7, true, 0), make_pos_t(7, true, 1) },
            { make_pos_t(6, true, 0), make_pos_t(6, true, 1) },
            { make_pos_t(5, true, 0), make_pos_t(5, true, 1) } }, "GTA" },
        { { { make_pos_t(6, true, 0), make_pos_t(6, true, 1) },
            { make_pos_t(5, true, 0), make_pos_t(5, true, 1) },
            { make_pos_t(4, true, 0), make_pos_t(4, true, 1) } }, "TAC" },
        { { { make_pos_t(5, true, 0), make_pos_t(5, true, 1) },
        ...
        { { { make_pos_t(4, true, 0), make_pos_t(4, true, 3) } }, "CCC" },
        { { { make_pos_t(4, true, 1), make_pos_t(4, true, 3) },
            { make_pos_t(1, true, 0), make_pos_t(1, true, 1) } }, "CCC" }
    };
