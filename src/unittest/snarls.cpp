...
namespace vg {
    namespace unittest {
        ...
        TEST_CASE( "SnarlManager finds the depths of each snarl",
                  "[snarls][depth]" ) {
            ...
            SECTION( "One nested snarl" ) {
                for (const Snarl* top_snarl : snarl_manager.top_level_snarls()) {
                    REQUIRE(snarl_manager.get_depth(top_snarl) == 0);
                }
                REQUIRE(snarl_manager.get_depth(snarl_manager.into_which_snarl(2, false)) == 1);
                REQUIRE(snarl_manager.get_depth(snarl_manager.into_which_snarl(3, false)) == 2);

            }
        } 
        TEST_CASE("Depth in unary snarl", "[snarls][depth]") {
            VG graph;
            ...
            SECTION("Check depths") {
                REQUIRE(snarl_manager.get_depth(snarl_manager.into_which_snarl(7, true)) == 0);
                REQUIRE(snarl_manager.get_depth(snarl_manager.into_which_snarl(2, true)) == 1);
                REQUIRE(snarl_manager.get_depth(snarl_manager.into_which_snarl(3, false)) == 1);
                REQUIRE(snarl_manager.get_depth(snarl_manager.into_which_snarl(1, true)) == 2);
            }
       }
   }
}
