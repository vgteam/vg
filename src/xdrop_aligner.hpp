...
namespace vg {
	...
	private:
        ...
        /// Compute (TODO: part of?) the alignment and return the winning final match, going in the given direction.
        ...
        /// Do alignment. Takes the graph, the sorted (TODO: what?) in
	...
	public:
         ...
         *
         * Compute an alignment of the given Alignment's sequence against the given graph, using (one of) the given MEMs to seed the alignment.
         *
         * reverse_complemented is false if aligning the read in its forward orientation, true otherwise.
         *
         ...
         *
         * The MEM list may be empty.
         * If MEMs are provided, uses only the begin, end, and nodes fields of the MaximalExactMatch objects.
         * It uses the first occurrence of the last MEM if reverse_complemented is true, and the last occurrence of the first MEM otherwise.
         */
