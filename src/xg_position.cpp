...
set<pos_t> xg_positions_bp_from(pos_t pos, int64_t distance, bool rev, const PathPositionHandleGraph* xgidx) {
    // handle base case
    //size_t xg_node_length(id_t id, PathPositionHandleGraph* xgidx);
    if (rev) {
...
void xg_annotate_with_initial_path_positions(const PathPositionHandleGraph* xgidx, Alignment& aln, size_t search_limit) {
    if (!aln.refpos_size()) {
...
void xg_expand_context(const PathPositionHandleGraph& xgidx, Graph& g, size_t dist, bool add_paths, bool use_steps,
...
void xg_expand_context_by_steps(const PathPositionHandleGraph& xgidx, Graph& g, size_t steps, bool add_paths,
                                bool expand_forward, bool expand_backward,
                                int64_t until_node) {
...
void xg_expand_context_by_length(const PathPositionHandleGraph& xgidx, Graph& g, size_t length, bool add_paths,
                                 bool expand_forward, bool expand_backward,
                                 int64_t until_node) {
