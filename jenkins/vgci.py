...
class VGCITest(TestCase):
    ...
    def test_sim_chr21_snp1kg(self):
        self._test_mapeval(300000, 'CHR21', 'snp1kg',
                           ...
                           sim_opts='-d 0.167 -p 500 -v 50 -S 12',
                           # 150 bp reads with 0.001 uniform error, combined with above should be same as -e 0.01 -i 0.002
                           sim_fastq=self._input('flat_150_001.fq'))
